...
<div class="row">
    <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card">
            <div class="card-body">
                <img src="{{asset('backend/images/profile/user-uploads/user-01.jpg')}}" class="rounded" width="230" alt="img"/>
            ...
            <div class="card-body"> <small class="text-muted">Email address </small>
                ...
                <br/>
                <button class="btn btn-circle btn-secondary"><em class="fa fa-facebook"></em></button>
                <button class="btn btn-circle btn-secondary"><em class="fa fa-twitter"></em></button>
                <button class="btn btn-circle btn-secondary"><em class="fa fa-youtube"></em></button>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <form action="{{url('profile-karyawan/update', $edit->id)}}" method="post">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-success"> <em class="fa fa-check"></em> Update</button>
