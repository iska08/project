            ...
            <thead>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <p style="text-align:right"><strong>Tanggal Masuk :</strong> <em class="fa fa-calendar"></em> {{carbon\carbon::parse($data->tgl_transaksi)->format('d-m-y')}}</p>
                        <p style="text-align:right"><strong>Tanggal Diambil :</strong> <em class="fa fa-calendar"></em> 
                            @if ($data->tgl_ambil == "")
                                Belum Diambil
                            @else
