            ...
            <div class="card-header d-flex align-items-start pb-0">
                ...
                <div class="avatar bg-rgba-primary p-50 m-0">
                    <div class="avatar-content">
                        <em class="feather icon-users text-primary font-medium-5"></em>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-start pb-0">
                ...
                <div class="avatar bg-rgba-success p-50 m-0">
                    <div class="avatar-content">
                        <em class="feather icon-box text-success font-medium-5"></em>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-start pb-0">
                ...
                <div class="avatar bg-rgba-danger p-50 m-0">
                    <div class="avatar-content">
                        <em class="feather icon-check text-danger font-medium-5"></em>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-start pb-0">
                ...
                <div class="avatar bg-rgba-warning p-50 m-0">
                    <div class="avatar-content">
                        <em class="feather icon-check-square text-warning font-medium-5"></em>
                    </div>
                </div>
            </div>
        </div>
