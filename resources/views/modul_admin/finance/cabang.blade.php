                ...
                <div class="card-body pt-50">
                    ...
                    <div class="chart-info d-flex justify-content-between mb-1">
                        <div class="series-info d-flex align-items-center">
                            <em class="fa fa-circle-o text-bold-700 text-primary"></em>
                    ...
                    <div class="chart-info d-flex justify-content-between mb-1">
                        <div class="series-info d-flex align-items-center">
                            <em class="fa fa-circle-o text-bold-700 text-warning"></em>
                    ...
                    <div class="chart-info d-flex justify-content-between mb-25">
                        <div class="series-info d-flex align-items-center">
                            <em class="fa fa-circle-o text-bold-700 text-info"></em>
